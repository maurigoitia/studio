...
export default function InfoPortalVeterinariasPage() {
  const features = [
    ...
    },
    {
      ...
      description: "Próximamente, GIA asistirá en la generación de resúmenes clínicos, búsqueda rápida de información relevante en historiales y protocolos, optimizando tu tiempo."
    },
    {
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      ...
      <section className="mb-16">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground text-center mb-12">Beneficios y Funcionalidades Destacadas</h2>
      ...
      <section id="early-access-vet" className="py-12 bg-secondary/50 rounded-lg shadow-xl">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
            Solicita Acceso Anticipado al Portal para Veterinarias
          </h2>
