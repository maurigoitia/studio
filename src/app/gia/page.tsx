...
export default function GIAPage() { 
  return (
    <div className="container mx-auto py-6 sm:py-12 px-2 sm:px-4"> {/* Adjusted padding for mobile */}
      <div className="max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto"> {/* Adjusted max-width for chat */}
        <Card className="shadow-xl">
          <CardHeader className="text-center pb-3 sm:pb-4"> {/* Reduced padding */}
            ...
            <CardDescription className="text-xs sm:text-base mt-1 sm:mt-2 space-y-1">
              <p>Soy GIA, tu asistente IA de PetSync. ¡Conversemos un poco para conocer mejor a tu mascota antes de tu consulta!</p>
              <p className="text-xs sm:text-sm mt-1">(Versión Demo Conversacional)</p>
            </CardDescription>
          </CardHeader>
          <CardContent className="px-2 sm:px-3 md:px-4 pb-3 sm:pb-6"> {/* Adjusted padding */}
